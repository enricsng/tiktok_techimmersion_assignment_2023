module github.com/enricsng/tiktok_techimmersion_assignment_2023/http-server

go 1.18

require (
	github.com/enricsng/tiktok_techimmersion_assignment_2023/http-server v0.0.0-20230518060359-4b2e6777fae0
